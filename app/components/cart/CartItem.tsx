      ...
      <div className="flex flex-1 flex-col justify-between">
        ...
        <Form method="post" className="flex items-center gap-3">
          ...
          <div className="flex divide-x-none rounded border border-gray-800">
            ...
            <span className="flex h-7 w-7 items-center justify-center text-sm">{quantity}</span>
            <button
              name="intent"
              value="increment"
              className="flex h-7 w-7 items-center justify-center text-sm"
          ...
          <button name="intent" value="remove" aria-label="Remove" className="text-gray-800">
            <Trash2 size={16} />
          </button>
        </Form>
      </div>
